...
class MyCustomModel:
    ...
    def __init__(self):
        self.device = "cpu"
        MyCustomModel.model = MyCustomModel.model or self._load_model()
    ...
    def _load_model(self):
        ...
        """
        model_path = os.getenv("MODEL_PATH", "assets/model_scripted.pt")
    ...
    def _inference(self, image):
        ...
        pred = MyCustomModel.model(image_unz)
...
if __name__ == '__main__':
    ...
    """
    what if this the model class initialized by two times
    -----------
    Now the model is only loaded once!
    """
    model = MyCustomModel()
